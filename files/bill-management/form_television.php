...
<body>
            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    <div class="alert alert-success" id="success-alert" style="display: none;">
                        <a href="television.php" class="close">x</a>
                    ...
                    <form enctype="multipart/form-data" method="post" name="television" id="television" style="width: 70%;margin-left: 15%;">
                    <div class="row">
                        <!-- ============================================================== -->
                        <!-- valifation types -->
                        <!-- ============================================================== -->
                                ...
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <select id="company_name" name="company_name" class="btn btn-secondary" style="background-color: grey;border-color: grey;">
                                                    <option value="DEN">DEN</option>
                                                    <option value="GTPL">GTPL</option>
                                                    <option value="DISH TV">DISH TV</option>
                                                    <option value="Tata Sky">Tata Sky</option>
                                                    <option value="Airtel">Airtel</option>
                                                    <option value="Jio Set-Top Box">Jio Set-Top Box</option>
    ...
    $url = $_GET['edit'];
        ...
        if($url == 'true')
        {
            ...
            $sql1 = "select * from bill_management where(home_id='".$_SESSION['homeid']."' and user_id='".$_SESSION['userid']."' and category='television' and issue_date='".$selected_issue_date."')";
            ...
            if(mysqli_num_rows($result1) > 0)
            {
                    ...
                    $soft_copy1=str_replace('image/bill management/television/',"", $soft_copy);
                    ...
                    {   
                        ...
                        if($url == 'true')
                        {
                            ...
                            $sql = "UPDATE bill_management SET due_date='$due_date' , amount='$amount' , duration_month='$duration_month' , paynment_status='$paynment_status' , paynment_mode='$paynment_mode' , notification_required='$notification_required' , soft_copy='$target' , company_name='$company_name'  
                                WHERE home_id='$homeid' AND user_id='$userid' AND category='television' AND issue_date='$issue_date'";
            ...
            if(!$conn)
            {
                ...
                echo "<script type='text/javascript'>
                    $(document).ready(function() {
                            ...
                            document.location.href='television.php';
                          });
                        });
                    </script>";
